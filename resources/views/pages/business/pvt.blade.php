...
@section('title', 'Private Limited Company Registration - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <h5  class="services-price">Price Starting From <span style="font-size: 14px;"><strike><i>₹19999/-</i></strike> </span> ₹9999/-  <span class="badge bg-success">50% Off</span></h5>
                                <p>A Private Limited Company (Pvt Ltd) offers limited liability protection to its owners, limiting their personal liability. It is a separate legal entity, ensuring continuity, and facilitates easy transfer of ownership. Pvt Ltd companies have advantages like tax benefits, access to funding, and credibility, making them an ideal choice for businesses seeking stability and growth.</p>
