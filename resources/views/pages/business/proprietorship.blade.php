...
@section('title', 'Sole Proprietorship - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <h5 class="services-price">Price Starting From <span style="font-size: 14px;"><strike><i>₹1599/-</i></strike> </span> ₹599/-  <span class="badge bg-success">80% Off</span></h5>
                                <p>Sole proprietorship is a business structure where one individual owns and operates the entire business. It offers simplicity, full control, and direct tax benefits. The owner is personally responsible for liabilities, and the business and personal assets are not separate.</p>
