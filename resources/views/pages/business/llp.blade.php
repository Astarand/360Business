...
@section('title', 'Limited Liability Partnership (LLP) Registration - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <h5 class="services-price">Price Starting From <span style="font-size: 14px;"><strike><i>₹13,999/-</i></strike> </span> ₹6999/-  <span class="badge bg-success">50% Off</span></h5>
                                <p>A Limited Liability Partnership (LLP) offers liability protection to its partners, combining the flexibility of a partnership with limited liability benefits. It's a popular business structure, providing legal protection for personal assets, tax advantages, and simplified management, making it an attractive option for small and medium-sized businesses.</p>
                        ...
                        <div class="row">
                            <div class="col-lg-10 my-auto">
                               <ul class="list-wrap1">
                                   ...
                                   <li>Affidavit Rent agreement</li>
                                   <li>Affidavit Office NOC by the rent owner.</li>
