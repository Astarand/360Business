...
@section('title', 'E-Commerce Business Registration - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <p>E-Commerce business facilitates online buying and selling, leveraging digital platforms for transactions. It enables global reach, 24/7 accessibility, diverse product offerings, secure payment options, and personalized shopping experiences, driving convenience and scalability for entrepreneurs.</p>
                                        ...
                                        <div class="accordion" id="accordionExample">
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>E-Commerce, or electronic commerce, refers to the buying and selling of goods and services over the internet. It involves the online transactions of goods and services between businesses, consumers, or individuals. E-Commerce platforms facilitate transactions by providing an online marketplace or storefront where buyers and sellers can interact and conduct business.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap1">
                                                            <li>Business-to-Consumer (B2C): Businesses sell products or services directly to consumers through online platforms.</li>
                                                            <li>Business-to-Business (B2B): Businesses sell products or services to other businesses through online marketplaces or specialized platforms.</li>
                                                            <li>Consumer-to-Consumer (C2C): Consumers sell products or services to other consumers through online platforms or marketplaces.</li>
                                                            <li>Consumer-to-Business (C2B): Consumers offer products or services to businesses, such as freelancers offering services to companies through online platforms.</li>
                                                            <li>Business-to-Government (B2G): Businesses sell products or services to government entities through online procurement portals or marketplaces.</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap1">
                                                            <li>Online storefront or platform: A website or mobile app where products or services are listed and transactions are conducted.</li>
                                                            <li>Product catalog: A database or collection of products or services available for sale, including descriptions, images, and prices.</li>
                                                            <li>Payment gateway: A secure payment processing system that allows customers to make online payments using credit/debit cards, digital wallets, or other payment methods.</li>
                                                            <li>Order management system: Software or platform that manages orders, inventory, shipping, and fulfillment processes.</li>
                                                            <li>Customer support: Channels for providing customer service and support, such as live chat, email, or phone support.</li>
                                                            <li>Marketing and promotion: Strategies and tactics for driving traffic to the online store, acquiring customers, and promoting products through digital marketing, social media, and other channels.</li>
                                                        </ul>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-10 my-auto">
                                <p>1. Address Proof ( Aadhar Card / Voter ID card )</p>
                                <p>2. Pan Card</p>
                                <p>3. Office related Papers ( Own / Rental ) </p>
                            </div>
                        </div>
                    </div>
                </div>
