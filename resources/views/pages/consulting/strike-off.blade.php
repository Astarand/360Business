...
@section('title', 'Strike Off Company - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <p>Striking off a company refers to the process of removing its name from the official registry, effectively dissolving it. This typically occurs when a company ceases operations, has no assets or liabilities, and wishes to close its legal entity. The process involves filing the necessary forms and documents with the appropriate government authorities, ensuring compliance with regulatory requirements. Once struck off, the company no longer exists as a legal entity, and its name is removed from public records.</p>
