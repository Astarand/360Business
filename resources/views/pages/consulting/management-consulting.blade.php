...
@section('title', 'Management Consulting - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <p>Management Consulting involves providing expert advice and assistance to organizations to improve their performance and solve complex business challenges. Consultants typically analyze existing business processes, identify areas for improvement, and develop strategies to enhance efficiency, productivity, and profitability. Services may include organizational restructuring, process optimization, change management, strategic planning, and implementation support. Management consultants bring specialized expertise and industry knowledge to help businesses achieve their goals and navigate through periods of growth, change, or crisis.</p>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        WWhat is Management Consulting?
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Management Consulting is a professional service provided by experts known as management consultants to organizations seeking advice and assistance in improving their performance, solving problems, and achieving their objectives. Management consultants analyze business issues, develop solutions, and provide recommendations to help organizations enhance their efficiency, effectiveness, and profitability.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What areas do management consultants specialize in?
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Management consultants specialize in various areas, including strategic planning, organizational design, process improvement, change management, financial management, marketing and sales strategy, human resources management, technology adoption, and performance measurement.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What types of organizations benefit from management consulting services?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Organizations of all sizes and industries can benefit from management consulting services. This includes small and medium-sized enterprises (SMEs), large corporations, government agencies, non-profit organizations, startups, and multinational corporations facing complex business challenges or seeking opportunities for growth and transformation.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the benefits of hiring a management consulting firm?
                                                    </button>
                                                </h2>
                                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>The benefits of hiring a management consulting firm include access to specialized expertise and resources, objectivity and impartiality in assessing business issues, fresh perspectives and innovative solutions, faster problem-solving and decision-making, improved organizational performance and efficiency, and enhanced competitiveness and growth opportunities.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
