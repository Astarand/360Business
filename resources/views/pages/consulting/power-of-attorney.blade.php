...
@section('title', 'Power Of Attorney - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                <h2 class="title">Power Of Attorney</h2>
                                <p>A Power of Attorney (POA) is a legal document granting someone else the authority to act on your behalf in various matters, including financial, legal, or medical decisions. This appointed individual, known as the agent or attorney-in-fact, can perform actions such as signing documents, managing assets, or making healthcare choices. POAs can be limited to specific tasks or broad in scope, depending on your needs. It's crucial to carefully consider whom you appoint and the extent of their authority when creating a Power of Attorney.</p>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>A Power of Attorney (POA) is a legal document that grants someone the authority to act on behalf of another person (the principal) in legal, financial, or medical matters. The person granted this authority is known as the attorney-in-fact or agent. The POA can be broad or limited in scope, depending on the wishes of the principal.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap1">
                                                            <li>General Power of Attorney: Grants broad authority to the agent to act on behalf of the principal in various matters.</li>
                                                            <li>Limited or Special Power of Attorney: Grants specific authority to the agent for a particular purpose or transaction.</li>
                                                            <li>Durable Power of Attorney: Remains in effect even if the principal becomes incapacitated.</li>
                                                            <li>Springing Power of Attorney: Becomes effective only upon the occurrence of a specific event, such as the principal's incapacity.</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What powers can be granted in a Power of Attorney?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>The powers granted in a Power of Attorney can include managing finances, signing legal documents, buying or selling property, making healthcare decisions, managing investments, and conducting business transactions. The scope of powers can be customized based on the needs and preferences of the principal.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        Who can create a Power of Attorney, and how is it executed?
                                                    </button>
                                                </h2>
                                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>A competent adult can create a Power of Attorney. To execute a POA, the principal must sign the document in the presence of witnesses and, in some cases, have it notarized. The agent may also need to accept their appointment and sign the document. Requirements for execution may vary depending on local laws.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
