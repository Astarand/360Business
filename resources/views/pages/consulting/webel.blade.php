...
@section('title', 'IT & ITES Permission- WEBEL - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <p>WEBEL (West Bengal Electronics Industry Development Corporation Limited) is authorized to grant IT & ITES permissions in West Bengal, India. This permission allows companies to operate in the Information Technology (IT) and Information Technology Enabled Services (ITES) sectors within the state. WEBEL facilitates the establishment of IT and ITES companies by providing necessary permissions, infrastructure, and support services. These permissions enable companies to set up offices, development centers, and service facilities, contributing to the growth of the IT industry in West Bengal.</p>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        What is WEBEL, and what role does it play in IT & ITES permissions?
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>WEBEL (West Bengal Electronics Industry Development Corporation Limited) is a government agency responsible for promoting the electronics and IT industry in West Bengal, India. It plays a crucial role in granting permissions and providing support services to IT & ITES companies operating in the state.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        Who needs IT & ITES permissions from WEBEL?
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>IT & ITES companies intending to establish or operate in West Bengal may require permissions from WEBEL. This includes companies involved in software development, IT consulting, BPO (Business Process Outsourcing), KPO (Knowledge Process Outsourcing), and other related services.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What types of permissions are provided by WEBEL to IT & ITES companies?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>WEBEL provides various permissions and support services to IT & ITES companies, including approvals for setting up IT parks, SEZs (Special Economic Zones), STPI (Software Technology Parks of India) units, and other infrastructure facilities. It also offers incentives, subsidies, and assistance in obtaining clearances from government departments.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the benefits of obtaining IT & ITES permissions from WEBEL?
                                                    </button>
                                                </h2>
                                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Obtaining IT & ITES permissions from WEBEL offers several benefits, including access to state-of-the-art infrastructure facilities, tax incentives, subsidies, government support, networking opportunities, and a conducive business environment for IT & ITES companies to thrive and grow in West Bengal.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
