...
@section('title', 'GST Notice & Clarification - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                <h2 class="title">GST Notice & Clarification</h2>
                                <p>GST notices and clarifications are official communications issued by the Goods and Services Tax (GST) authorities to taxpayers regarding compliance issues or inquiries. These notices may include requests for additional information, explanations, or responses to specific queries related to GST filings or transactions. They serve to ensure adherence to GST regulations and provide clarity on any discrepancies or concerns raised by tax authorities, aiming to facilitate smooth tax administration and compliance for businesses and taxpayers.</p>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        What are GST Notices, and why are they issued?
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>GST Notices are official communications issued by the Goods and Services Tax (GST) authorities to taxpayers, businesses, or entities to seek clarification, provide information, or address compliance issues related to GST laws and regulations. They are issued to ensure compliance with GST provisions and address any discrepancies or non-compliance detected by the tax authorities.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What types of GST Notices can taxpayers receive?
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Taxpayers can receive various types of GST Notices, including notices for non-filing of returns, mismatch in declared and actual turnover, discrepancies in input tax credit (ITC) claims, pending tax payments, and requests for additional information or documents to support GST filings or claims.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What should taxpayers do upon receiving a GST Notice?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Upon receiving a GST Notice, taxpayers should carefully review the notice to understand the nature of the issue or query raised by the tax authorities. They should promptly respond to the notice within the specified timeframe, provide the requested information or clarification, and take necessary actions to rectify any non-compliance or discrepancies identified.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
