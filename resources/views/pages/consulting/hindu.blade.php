...
@section('title', 'Hindu Undivided Family ( HUF) Deed - 360 Business & Services')
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        What is a Hindu Undivided Family (HUF) Deed?
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <P>A Hindu Undivided Family (HUF) Deed is a legal document that establishes the existence of a Hindu Undivided Family and outlines its rights, properties, and obligations. It defines the members of the HUF, their roles, and their shares in the family's assets and income.</P>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        Who can create a Hindu Undivided Family (HUF) Deed?
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <P>A Hindu Undivided Family (HUF) Deed is typically created by the head of the family (known as the Karta) to formalize the existence of the HUF and its properties. The Karta has the authority to manage the affairs of the HUF and execute legal documents on its behalf.</P>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the key components of a Hindu Undivided Family (HUF) Deed?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>The key components of a HUF Deed include the identification of the Karta and other members of the family, a declaration of the family's joint status, a list of the family's properties (both ancestral and self-acquired), provisions for the management and distribution of income and assets, and rules for succession and inheritance within the HUF.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        Is a Hindu Undivided Family (HUF) Deed legally binding?
                                                    </button>
                                                </h2>
                                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Yes, a HUF Deed is a legally binding document that governs the rights and obligations of the members of the HUF and their dealings with the family's assets and income. It can be enforced in a court of law in case of disputes or challenges to the validity of the deed.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
