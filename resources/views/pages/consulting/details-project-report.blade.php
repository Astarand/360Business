...
@section('title', 'Details Project Report - 360 Business & Services')
                    ...
                    <div class="col-lg-7">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                <h2 class="title">Details Project Report (DPR) With CMI Data</h2>
                                <p>A Detailed Project Report (DPR) with CMI data provides a comprehensive analysis of a project's feasibility, financial viability, and implementation strategy. It incorporates Cost Monitoring and Index (CMI) data, offering insights into cost fluctuations and trends, ensuring accurate budgeting and forecasting. The DPR with CMI data facilitates informed decision-making by stakeholders, enhances project planning, and mitigates financial risks, ultimately leading to successful project execution and outcomes.</p>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>A Detailed Project Report (DPR) is a comprehensive document that outlines the key aspects of a proposed project, including its objectives, scope, feasibility, technical requirements, financial projections, implementation plan, and potential risks. It serves as a roadmap for project stakeholders, investors, and decision-makers to assess the viability and potential impact of the project.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What is CMI Data, and how is it relevant to the DPR?
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>CMI (Credit Monitoring Arrangement) Data refers to financial data collected and monitored by banks and financial institutions as part of their credit risk management processes. It includes information such as credit scores, repayment history, loan utilization, and other credit-related metrics of borrowers. CMI Data can provide valuable insights into the financial health and creditworthiness of project stakeholders, which are essential inputs for assessing the feasibility and risk factors of a project outlined in the DPR.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the key components of a DPR with CMI Data?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>A DPR with CMI Data typically includes sections covering project overview and background, market analysis and demand assessment, technical and operational aspects, financial projections and investment requirements, risk analysis and mitigation strategies, regulatory and environmental compliance, and evaluation of project stakeholders' financial profiles based on CMI Data.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
