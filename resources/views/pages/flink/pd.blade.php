...
@section('title', 'Property Registration & Deed - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                <h2 class="title">Property Registration & Deed</h2>
                                <p>Property registration and deed are essential legal processes involved in transferring property ownership. Property registration entails registering the property with the government to establish legal ownership. The deed is a legal document that outlines the terms of the property transfer, including buyer and seller details, property description, and purchase price. Both processes ensure the legality and validity of property transactions, providing protection and clarity to all parties involved in real estate transactions.</p>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        What is a Property Deed, and what role does it play in property registration?
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>A Property Deed is a legal document that conveys ownership of a property from one party to another. It includes details such as the names of the buyer and seller, property description, sale consideration, and terms and conditions of the sale. The Property Deed serves as the primary document for property registration and transfer of title.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the types of Property Deeds used for registration?
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap1">
                                                            <li>Sale Deed: Used for transferring ownership of a property from the seller to the buyer in exchange for a sale consideration.</li>
                                                            <li>Gift Deed: Used for gifting or transferring ownership of a property from one party to another without any monetary consideration.</li>
                                                            <li>Lease Deed: Used for leasing or renting out a property for a specified period, outlining the terms and conditions of the lease agreement.</li>
                                                            <li>Mortgage Deed: Used for mortgaging a property as security for a loan, specifying the terms of the mortgage agreement between the borrower and lender.</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the benefits of registering property and executing a Property Deed?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap1">
                                                            <li>Legal recognition of ownership rights: Registration of property and execution of a Property Deed provide legal proof of ownership rights, protecting the buyer's interests and preventing disputes over property ownership.</li>
                                                            <li>Transfer of title: Property registration facilitates the transfer of title from the seller to the buyer, ensuring clear and marketable title to the property.</li>
                                                            <li>Enforcement of rights: Registered property transactions and Property Deeds are admissible as evidence in court, allowing parties to enforce their rights and seek legal remedies in case of disputes.</li>
                                                            <li>Access to credit: Registered property can be used as collateral for loans and mortgages, enabling property owners to access financing for various purposes.</li>
                                                            <li>Compliance with legal requirements: Property registration and deed execution fulfill legal requirements and formalities mandated by law, ensuring compliance with land laws and regulations.</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
