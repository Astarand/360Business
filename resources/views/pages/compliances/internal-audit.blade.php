...
@section('title', 'Internal Audit - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <p>Internal audit is an independent, objective assurance and consulting activity designed to add value and improve an organization's operations. It helps achieve organizational objectives by evaluating and improving the effectiveness of risk management, control, and governance processes. Internal auditors assess key areas such as financial management, compliance with regulations, and operational efficiency. They provide insights and recommendations to management for addressing weaknesses and enhancing internal controls. Internal audit plays a critical role in enhancing transparency, accountability, and the overall success of an organization.</p>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>An Internal Audit is an independent, objective assurance and consulting activity designed to add value and improve an organization's operations. It helps organizations achieve their objectives by evaluating and improving the effectiveness of risk management, control, and governance processes.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        Who conducts Internal Audits, and what is their role?
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Internal Audits are conducted by internal auditors who are employees of the organization or outsourced to a third-party audit firm. Their role is to assess the organization's processes, procedures, and controls to identify areas of risk, inefficiency, or non-compliance with policies and regulations.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>The objectives of an Internal Audit include evaluating the effectiveness and efficiency of operations, assessing the reliability of financial reporting, ensuring compliance with laws, regulations, and internal policies, safeguarding assets, and identifying opportunities for improvement in internal controls and processes.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        How often are Internal Audits conducted, and what is the process?
                                                    </button>
                                                </h2>
                                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>The frequency of Internal Audits varies depending on the organization's size, complexity, industry, and regulatory requirements. Internal Audits may be conducted annually, quarterly, or more frequently as needed. The process typically involves planning the audit, assessing risks, conducting fieldwork, analyzing findings, and reporting results to management and the audit committee.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
