...
@section('title', 'GST Annual Fillings - 360 Business & Services')
                    ...
                    <div class="col-lg-7  order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                <h2 class="title">GST Annual Fillings</h2>
                                <p>GST Annual Filing is a mandatory requirement for businesses registered under the Goods and Services Tax (GST) regime in India. It involves the submission of various annual returns and reconciliation statements, including GSTR-9 and GSTR-9C, to the tax authorities. These filings summarize the taxpayer's financial transactions for the entire financial year. The deadline for GST Annual Filing is typically December 31st of the subsequent financial year. Non-compliance or late filing may result in penalties imposed by the tax authorities.</p>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        What are GST Annual Filings?
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>GST Annual Filings refer to the submission of annual returns under the Goods and Services Tax (GST) regime. They are required for businesses registered under GST to provide a summary of their financial activities, tax liabilities, and compliance with GST regulations for the entire financial year.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>All businesses registered under GST, including regular taxpayers, composition scheme taxpayers, and e-commerce operators, need to file GST Annual Returns. However, specific criteria may apply, and exemptions may be available for certain categories of taxpayers.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the consequences of not filing GST Annual Returns?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Failure to file GST Annual Returns may result in penalties, fines, and legal actions by the tax authorities. Additionally, non-filing or late filing of annual returns may lead to the suspension or cancellation of GST registration, loss of input tax credit, and disruptions in business operations.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the steps involved in filing GST Annual Returns?
                                                    </button>
                                                </h2>
                                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>The steps involved in filing GST Annual Returns typically include gathering all relevant financial documents and records for the financial year, reconciling data, preparing the GSTR-9 form, and filing it electronically through the GST portal within the prescribed deadline. It is essential to ensure accuracy and compliance with GST regulations to avoid penalties and consequences.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
