...
@section('title', 'Import Export Code Registration - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                <h2 class="title">Import Export Code Registration</h2>
                                <h5>Price Starting From <span style="font-size: 14px;"><strike><i>₹2999/-</i></strike> </span> ₹1499/-  <span class="badge bg-success">50% Off</span></h5>
                                <p>IEC (Import Export Code) registration is a mandatory document for businesses engaged in international trade. It's a unique 10-digit code issued by the government to facilitate cross-border transactions. Required for importing or exporting goods, IEC registration is obtained from the Directorate General of Foreign Trade (DGFT) in India. It helps businesses gain global market access and is crucial for customs clearance. The process involves submitting an application with essential documents, and once obtained, the IEC is valid for a lifetime. It simplifies foreign trade procedures and ensures compliance with international regulations.</p>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>An Import Export Code (IEC) is a 10-digit unique identification number issued by the Directorate General of Foreign Trade (DGFT), Ministry of Commerce and Industry, Government of India. It is mandatory for any person or entity engaged in import or export activities in India, except for certain categories exempted from obtaining IEC.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the features of an Import Export Code (IEC)?
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>An Import Export Code serves as a primary identification number for exporters and importers in India, facilitating customs clearance, international trade transactions, and compliance with foreign trade regulations. It is valid for the lifetime of the entity and does not require renewal.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        What are the advantages of obtaining an Import Export Code (IEC)?
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Obtaining an IEC enables businesses to engage in international trade activities, including importing goods into India and exporting goods from India, by providing a unique identification number recognized by customs authorities and financial institutions. It also allows businesses to avail of various benefits and incentives offered under foreign trade policy schemes.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        Are there any compliance requirements associated with Import Export Code (IEC)?
                                                    </button>
                                                </h2>
                                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>While there are no specific compliance requirements associated with IEC, businesses are required to comply with relevant foreign trade policies, customs regulations, and reporting requirements applicable to their import and export activities. Additionally, any changes in business details or status must be updated with the DGFT to maintain the accuracy of the IEC record.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row mx-lg-2">
                            <div class="col-lg-12">
                                <ul class="list-wrap1">
                                    ...
                                    <li>Photo of Contact Person</li>
                                    <li>Cancelled cheque</li>
                                    <li>Mobile &amp; Email id of Contact person</li>
                                </ul>
                            </div>
                        </div>
                    </div>
