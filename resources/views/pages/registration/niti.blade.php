...
@section('title', 'Niti Ayog (Darpan) Registration - 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <p>NITI Aayog (Darpan) registration is essential for NGOs to access government grants, showcase impact, and contribute to social development transparently and efficiently.</p>
