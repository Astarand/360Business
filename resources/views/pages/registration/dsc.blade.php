...
@section('title', 'Digital Signature Registration - 360 Business & Services')
                    ...
                    <div class="col-lg-7">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <h5>Price Starting From <span style="font-size: 14px;"><strike><i>₹1199/-</i></strike> </span> ₹599/-  <span class="badge bg-success">50% Off</span></h5>
                                <p>Digital signatures (DSC) ensure secure online transactions, authenticate identities, and validate electronic documents, enhancing data integrity and confidentiality. They provide a tamper-evident seal for digital information, fostering trust in digital communication and safeguarding against unauthorized alterations.</p>
