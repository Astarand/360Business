...
@section('title', 'Start Up Registration- 360 Business & Services')
                    ...
                    <div class="col-lg-7 order-lg-0 order-0">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <p>Startup registration is crucial for legal recognition, access to funding, and compliance. It establishes credibility, facilitates partnerships, and ensures a smooth business journey, creating a foundation for growth and protection in the competitive market.</p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row mx-lg-2">
                            <div class="col-lg-12">
                                <ul class="list-wrap1">
                                    <li>KYC (Aadhaar card and Pan card) of the directors of the company</li>
                                    <li>One photograph of each director of the company is required</li>
                                    <li>Contact details and email addresses of all the directors of the company</li>
                                    <li>The incorporation certificate of the company will be needed during registration</li>
                                    <li>Bank account details of all the directors of the company</li>
                                    <li>Business Address Proof of the Company</li>
                                    <li>PAN card or PAN card details of the company</li>
                                    <li>Address proof of all the directors who are part of the company</li>
                                    <li>MOA and AOA of the company will be required</li>
                                    <li>DIN and DSC will be required</li>
                                    <li>Shop and Establishment Certificate of the Company</li>
                                    <li>GST registration certificate of the company</li>
                                    <li>MSME, or Udyam, registration of the company</li>
                                </ul>
                            </div>
                        </div>
                    </div>
