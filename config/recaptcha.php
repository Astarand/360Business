 ...
 * MIT compliances: https://github.com/biscolab/laravel-recaptcha/blob/master/LICENSE
 */
...
return [
    ...
    'tag_attributes'               => [
         ...
         * If flink elements in your page use tabindex, it should be set to make user navigation easier.
         */
        'tabindex'         => 0,
